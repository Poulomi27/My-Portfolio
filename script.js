...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio | Poulomi Pal";
        $("#favicon").attr("href","assests/images/portrait.jpg");
    }
    else {
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["Web development", "Machine Learning", "Data Analysis", "Tech Communities"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
